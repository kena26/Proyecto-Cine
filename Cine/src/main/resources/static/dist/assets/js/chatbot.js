document.addEventListener("DOMContentLoaded", function () {
    ...
    function handleUserInput(userMessage, isUserImage) {
        ...
        const response = responses[userMessage] || "No entiendo tu pregunta. Escribe 'ayuda' para ver las opciones disponibles.";
    ...
    function addMessage(sender, message, isUser) {
        ...
        avatar.src = isUser ? "/Cine/src/main/resources/static/dist/assets/img/logo.png" : "/Cine/src/main/resources/static/dist/assets/img/logo.png";
